  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <h1 className={classNames("text-7xl font-extrabold py-2 ")}>
            <span className="text-amber-600">We Fight</span> For Your Right
          </h1>
          <p className={classNames("text-xl tracking-widest font-sans px-2 py-4")}>
            We Help You Protect What's Yours.
          </p>
          <button
            className={classNames(
              "font-sans mx-4 bg-amber-600 rounded-full px-6 py-4 font-mediu text-white"
            )}
          >
            FREE CONSULTATION
          </button>
