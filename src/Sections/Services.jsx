      ...
      <div className={classNames(divClass, "w-[700px]")}>
        {services.map((item) => (
          <div className={classNames(subDivs)}>
            ...
            <p className={classNames(pTag)}>{item.desp}</p>
          </div>
        ))}
      </div>
    </section>
...
const subDivs =
  "flex flex-col justify-center items-start p-2 w-full md:w-[46%]";
const h2Tag = "text-white tracking-tighter text-4xl md:text-6xl";
const pHeadTag = "md:text-8xl text-7xl font-thin text-white pb-4";
const spanTag = "text-amber-600 font-normal";
